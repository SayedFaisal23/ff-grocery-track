...
<button
    type="button"
    class="claim-summary claim-mobile-summary"
    data-claim-modal-open="{{ $modalId }}"
    aria-haspopup="dialog"
    aria-controls="{{ $modalId }}"
    aria-label="View details for {{ $itemName }}"
>
    <span class="claim-summary-main claim-mobile-summary-main">
        <strong class="claim-item-name claim-mobile-item-name">{{ $itemName }}</strong>
        <x-tuntutan-type-badge :claim="$claim" />
    </span>
    <span class="claim-summary-submitter claim-mobile-summary-submitter">
